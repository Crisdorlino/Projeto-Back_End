...
// Criar associação entre produto e fornecedor
...
router.get("/fornecedor/:fornecedorId/produtos", associacaoController.getProdutosPorFornecedor);

// Listar fornecedores de um produto
router.get("/produto/:produtoId/fornecedores", associacaoController.getFornecedoresPorProduto);
